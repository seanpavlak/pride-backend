# pride-backend
[Privacy Preserving Federated Learning on a Deep Neural Network](https://github.com/seanpavlak/pride-backend/blob/master/mnist_federated_learning.ipynb)
...
Utilizing a form of differential privacy or homomorphic encryption has been utilized for some studies [Geyer:Differentially, McMahan:Federated, Nabi:Privacy] with success, lending me to believe that this level of privacy should be sufficient in preventing adversaries.
...
This can be overcome by performing differential privacy or secret sharing between parties so that the cloud does not have access to the encrypted data provided by the users. This methods has been shown to be effective, yet inefficient in many different studies. Such as in Geyer [Geyer:Differentially] and Nabi [Nabi:Privacy]. 
